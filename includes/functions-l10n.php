...
class YOURLS_Locale_Formats {
	...
	function init() {
		...
		// The Months
		$this->month['01'] = /* //translators: month name */ yourls__( 'Janeiro' );
		$this->month['02'] = /* //translators: month name */ yourls__( 'Fevereiro' );
		$this->month['03'] = /* //translators: month name */ yourls__( 'Março' );
		$this->month['04'] = /* //translators: month name */ yourls__( 'Abril' );
		$this->month['05'] = /* //translators: month name */ yourls__( 'Maio' );
		$this->month['06'] = /* //translators: month name */ yourls__( 'Junho' );
		$this->month['07'] = /* //translators: month name */ yourls__( 'Julho' );
		$this->month['08'] = /* //translators: month name */ yourls__( 'Agosto' );
		$this->month['09'] = /* //translators: month name */ yourls__( 'Setembro' );
		$this->month['10'] = /* //translators: month name */ yourls__( 'Outubro' );
		$this->month['11'] = /* //translators: month name */ yourls__( 'Novembro' );
		$this->month['12'] = /* //translators: month name */ yourls__( 'Dezembro' );
