...
define( 'YOURLS_DB_USER', 'israelwilson' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '15r43l' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'encurtadb' );
 ...
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_PREFIX', 'encurta_' );
...
define( 'YOURLS_SITE', 'http://localhost/encurtador' );
...
$yourls_user_passwords = [
	'israelwilson' => 'phpass:!2y!10!zJ4mQwBsf0/45HD924ToJujjSUhETkcYDvploggNSkviXcnzpetk6' /* Password encrypted by YOURLS */ ,
	// 'username2' => 'password2',
